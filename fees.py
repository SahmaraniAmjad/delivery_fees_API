class fees:
    ...
    def fees_for_number_of_items(self, number_of_items):
        ...
        if number_of_items == 0:
            print("You have to add an item to proceed")
        elif 1 <= number_of_items <= 4:
            return 0
        else:
    ...
    def fees_for_friday_rush_hours(self, time_for_order):
        ...
        hour = unix_timestamp.hour
        day = date.today().weekday()
        print(hour)
        print(f"unix_timestamp: {unix_timestamp}\n day: {day} \n hour: {hour}")
        if day == 4 and 15 <= hour <= 19:
            return 1.1
        else:
            print(1)
            return 1
    ...
    def delivery_fees(self, cart_value, delivery_distance, number_of_items, time_for_order):
        ...
        #     print("Case one")
        #     if fees_with_surcharge > 1500:
        #         return "delivery fees are maximum 15 Euros, maybe the distance is too long, or you add too much items"
        #     else:
        #         return int(fees_with_surcharge * friday_delivery_fees)
        ...
        #     print("Case three")
        #     if fees_without_surcharge * 1.1 > 1500:
        #         return "delivery fees are maximum 15 Euros, maybe the distance is too long, or you add too much items"
        #     else:
        #         return int(fees_without_surcharge * friday_delivery_fees)
        elif cart_value >= 1000:
            print("Case four")
            # if fees_without_surcharge > 1500:
            #     return "delivery fees are maximum 15 Euros, maybe the distance is too long, or you add too much items"
            # else:
            #     return int(fees_without_surcharge)
            return int(fees_without_surcharge * friday_delivery_fees)
